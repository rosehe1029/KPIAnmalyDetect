...
data=pd.read_csv("data_balance.csv")#, parse_dates=True, index_col='_time')
#data=data.sort_index(ascending=True) 
X,y=data.iloc[:,:-1],data.iloc[:,-1]


X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.40,shuffle=True)#, random_state=1029)
